<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Dharanidharan%20T&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full-Stack%20Developer%20%7C%20AI%20Enthusiast%20%7C%20Hackathon%20Champion&descAlignY=62&descSize=16"/>
...
<details>
  <summary>🏢 <strong>MERN Intern</strong> — CRM for College | 2025</summary>
  <br/>
  > `MongoDB` `Express.js` `React` `Node.js` `AWS` `Tailwind CSS` `Ant Design` `JavaScript`

  - 🏗️ Developed a full-featured **College CRM system** with role-based access control for Admin, Faculty, and Teacher roles.
  - 🎨 Built **responsive frontend interfaces** using HTML, Tailwind CSS, JavaScript, React, and Ant Design components.
  - ⚙️ Implemented core features including **user creation, attendance marking, and downloadable reports** with smooth UX flows.
...
|---|---|---|
| 🥈 | **Freshaton — 2nd Prize** | Dept-level competition win for Serena AI (emotional intelligence app) |
| 🏆 | **Smart India Hackathon 2025 — Round 3** | Team Lead, Unity Minds — AI Rockfall Prediction system (Rocksense) |
| 🏆 | **PALS InnoWah — Finalist** | Team Lead, Unity Minds — Hardware + AI Rockfall Alert System |
| 🤖 | **Gen AI Hackathon (SmartBridge) — Team Lead** | Built StudyCore using IBM Granite + Gemini AI; earned IBM SkillsBuild GenAI certification |
| 💻 | **LeetCode — 250+ Problems Solved** | Max Rating: **1,430** · Global Ranking: **615,084** |
...
🎨 UI/UX Design      → Figma for Web & Mobile, Design Systems
⚡ Competitive DSA   → Advanced Graph Algorithms, DP Optimization
☁️  Cloud & DevOps   → AWS Services, CI/CD Pipelines
```
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:dharanidh02@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/dharanidharan-t-180a79321/)
...
<div align="center">
  <i>"Build fast. Break things. Learn faster. 🚀"</i>
</div>
